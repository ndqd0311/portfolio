...
export default function DragonCursor() {
  ...
  useEffect(() => {
    ...
    // Scaling factor to make the dragon cursor sleeker and match the website layout.
    // 0.22 is a perfect size for a cursor.
    ...
    const run = () => {
      ...
      for (let i = 1; i < N; i++) {
        ...
        // Base scale calculation scaled down by our SCALE_FACTOR
        const s = ((162 + 4 * (1 - i)) / 50) * SCALE_FACTOR;
  ...
  return (
    ...
    >
      <defs>
        {/* Cabeza (Head) with white accents and electric cyan outer skin */}
        ...
        {/* Aletas (Fins/Wings) gradient fading from Electric Cyan to transparent dark background */}
        ...
        {/* Espina (Spine/Body segments) gradient in Electric Cyan transitioning to subtle dark gray */}
