      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="font-sans text-sm text-on-surface-variant">
            Powered by Google Analytics 4 &amp; Database metrics.
          </p>
        </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2 px-3 py-1.5 glass-card rounded-xl border border-white/5 bg-surface-dark/30">
                ...
                <span className="font-mono text-xs text-on-surface-variant">Google Analytics 4</span>
              </div>
            </div>
          ...
          {gaError && (
            <div className="glass-card rounded-2xl border border-red-500/10 p-8 bg-red-500/5 max-w-3xl mx-auto space-y-5">
              ...
              <div className="bg-black/20 rounded-xl p-5 border border-white/5 space-y-4">
                <p className="font-mono text-xs text-electric-cyan font-semibold uppercase tracking-wider">Hướng dẫn cài đặt Service Account</p>
                <ol className="list-decimal list-inside font-sans text-xs text-on-surface-variant space-y-2.5 leading-relaxed">
                  <li>
                    Vào <a href="https://console.cloud.google.com/iam-admin/serviceaccounts" target="_blank" rel="noopener noreferrer" className="text-electric-cyan hover:underline">Google Cloud Console → Service Accounts</a>
                  </li>
                  <li>Tạo project mới (hoặc chọn project hiện có), bật <strong>Google Analytics Data API</strong></li>
                  <li>Tạo Service Account → Tạo JSON key → Download file JSON</li>
                  <li>
                    Vào <a href="https://analytics.google.com" target="_blank" rel="noopener noreferrer" className="text-electric-cyan hover:underline">Google Analytics</a> → Admin → Property Access Management → Thêm email của Service Account với quyền <strong>Viewer</strong>
                  </li>
                  <li>
                    Thêm nội dung file JSON vào biến môi trường:
                    <pre className="font-mono text-[11px] text-electric-cyan bg-black/30 rounded-lg p-3 select-all mt-2 whitespace-pre-wrap break-all">
{`GA_SERVICE_ACCOUNT_KEY={"type":"service_account","project_id":"...","private_key":"...","client_email":"...",...}`}
                    </pre>
                  </li>
                  <li>Thêm vào Vercel: Settings → Environment Variables → <code className="bg-white/5 px-1 rounded">GA_SERVICE_ACCOUNT_KEY</code></li>
                </ol>
              </div>
